...
COIN_TGZP='https://github.com/opalcoinnet/opalcoin/releases/download/v2.0/Opalcoin-Linux1604.zip'
COIN_BOOTSTRAP='https://github.com/opalcoinnet/opalcoin/releases/download/v2.0/bootstrap.zip'
