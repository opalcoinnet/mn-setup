...
COIN_TGZP='https://github.com/opalcoinnet/opalcoin/releases/download/v2004/opalcoin-daemon-linux.zip'
COIN_BOOTSTRAP='https://github.com/opalcoinnet/opalcoin/releases/download/v2004/Bootstrap.zip'
