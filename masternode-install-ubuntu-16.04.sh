...
COIN_TGZP='https://github.com/opalcoinnet/opalcoin/releases/download/v2002/Opalcoin-2002-Linux1604.zip'
COIN_BOOTSTRAP='https://github.com/opalcoinnet/opalcoin/releases/download/v2002/Bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='opalcoin'
COIN_NAME_OLD='opalcoind'
PROJECT_NAME='Opalcoin (opal)'
